...
<br />
	<div id="print">
		<div style = "margin:10px;">	
			<label style = "font-size:18px;"><center>SAN CARLOS DIAGNOSTIC LABORATORY</center></label>
			...
			<div style = "float:left; width:45%; margin-left:50px;">
				...
				<br />
				<label style = "font-size:12px; position:relative; top:-30px;">Red Blood Cell Count: 
					<?php 
						if($f['RBC_count'] == ""){
							echo "<u>
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				...
				<br />
				<label style = "font-size:12px; position:relative; top:-40px;">Whte Blood Cell Count: 
					<?php 
						if($f['WBC_count'] == ""){
							echo "<u>
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
