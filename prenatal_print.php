...
<br />
	<div id="print" style = "max-width:850px;">
		<div style = "margin:10px;">	
			...
			<center><label>Province of Pangasinan</label></center>
			<center><label>CITY OF SAN CARLOS</label></center>
			<center><label>City San Carlos Health Care Management System 2023 Office</label></center>
