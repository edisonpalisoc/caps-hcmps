	...
	<div id="print">
		<div style = "margin:10px;">
			...
			<div style = "margin-right:190px;">
				...
				<label><center>Probinsya ng Pangasinan</center></label>
				<label><center>LUNGSOD NG SAN CARLOS</center></label>
				<label><center>CITY San Carlos Health Care Management System 2023 OFFICE</center></label>
			</div>
			<br />
