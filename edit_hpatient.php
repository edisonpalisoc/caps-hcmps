...
<html lang = "en">
	...
	<div class = "navbar navbar-default navbar-fixed-top">
		<img src = "images/hc.png" style = "float:left;" height = "55px"><label class = "navbar-brand">San Carlos Health Care Management System 2023 Patient Healthcare San Carlos HealthcareSan Carlos Health Care Management System 2023</label>
	...
	<div class = "well">
		<div class = "panel panel-warning">
			<div class = "panel-heading">
				<center><label>San Carlos</label></center>
			</div>
		</div>
			...
			<div class = "panel-body">
				<form id = "form_dental" action = "edit_patient.php?id=<?php echo $fetch['itr_no']?>&lastname=<?php echo $fetch['lastname']?>" method = "POST" enctype = "multipart/form-data">
					...
					<div class = "form-inline">
						...
						<label style = "float:right; margin-top:5px;" for = "phil_health_no">Phil San Carlos Health Care Management System 2023 no:</label>
					</div>
					<br />
					<div class = "form-inline">
					...
					<div class = "form-inline">
						...
						<label for = "rr">RESPERATORY RATE:</label>
