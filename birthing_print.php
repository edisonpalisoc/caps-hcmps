...
<br />
	<div id="print" style = "max-width:850px;">
		<div style = "margin:10px;">	
			<center><label><b>SAN CARLOS CITY San Carlos Health Care Management System 2023 OFFICE</b></label></center>
			<center><label>SAN CARLOS CITY, PANGASINAN</label></center>
			<br />
